            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(getContext(), "Cập nhật ảnh không thành công", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
                }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == IMAGE_REQUEST && requestCode == -RESULT_OK && data != null && data.getData() != null) {
            ...
            if (uploadTask != null && uploadTask.isInProgress()){
                Toast.makeText(getContext(),"Ảnh đang được tải lên...",Toast.LENGTH_SHORT).show();
            }
            else{
                uploadImage();
            }
